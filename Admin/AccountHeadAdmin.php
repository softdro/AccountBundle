...
class AccountHeadAdmin extends Admin {

    protected $parentAssociationMapping = 'account_head';
    protected $baseRoutePattern = 'account_head';
...
//        '_sort_order' => 'DESC',
    ...
    protected function configureFormFields(FormMapper $formMapper) {
        ...
        $formMapper
                ->add('title', null, array('attr' => array('placeholder' => 'Account Head'))) 
                ->add('code')
                ->end()
