...
//                ->add('account_head', ModelAutocompleteType::class, array(
//                    'required' => FALSE,
//                    'btn_add' => FALSE,
...
//                ))
                ->add('code')
//                ->add('parent', null, array('admin_code' => 'acme.account.admin.account'))
                ->add('isAsset')
                ->add('enable')
                ->end()
...
//                )
                ->add('account_group', CollectionType::class, array(
                    'by_reference' => false,
                        ), array(
                    'edit' => 'inline',
//                    'sortable' => 'pos',
                    'inline' => 'table',
                    'admin_code' => 'app.acme.account.admin.account_group',
                ))
                ->end()
    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper) {
        $datagridMapper
                ...
                ->add('account_group', null, array('show_filter' => true, 'admin_code' => 'app.acme.account.admin.account_group'))
//                ->add('group', null, array('show_filter' => true))
//                ->add('group', null, array(), 'entity', array(
//                    'class' => 'AppAcmeAccountBundle:Group',
//                    'property' => 'title',
//                ))
...
//                        ))
    ...
    protected function configureListFields(ListMapper $listMapper) {
        $listMapper
                ...
                ->addIdentifier('title')
                ->add('account_head')
                ->add('account_group', null, array('admin_code' => 'app.acme.account.admin.account_group'))
//                ->add('group', null, array(
