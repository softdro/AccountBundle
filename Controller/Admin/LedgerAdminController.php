...
/**
 * Description of CommentAdminController
 *
 * @author modasser
 */
...
class LedgerAdminController extends Controller {
    ...
    /**
      # Route("/create", name="acme_organization_member_create")
     * @Method("POST")
     * # @Template("AcmeOrganizationBundle:OrganizationMember:new.html.twig")
     */
